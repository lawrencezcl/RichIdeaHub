...
// Validate ../../src/app/api/bulk-fetch/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/bulk-fetch">> = Specific
  const handler = {} as typeof import("../../src/app/api/bulk-fetch/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/api/distribute/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/distribute">> = Specific
  const handler = {} as typeof import("../../src/app/api/distribute/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
